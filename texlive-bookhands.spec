...
License:	LPPL
Source0:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/bookhands.r%{version}.tar.xz
Source1:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/bookhands.doc.r%{version}.tar.xz
Source2:	http://mirrors.ctan.org/systems/texlive/tlnet/archive/bookhands.source.r%{version}.tar.xz
BuildArch:	noarch
